...
namespace Example
{
    ...
    class Graph
    {
        ...
        public void Dijkstra(int start)
        {
            ...
            Console.WriteLine("Кратчайшие расстояния от вершины " + start + " (Дейкстра):");
        ...
        public void UnweightedShortestPaths(int start)
        {
            ...
            Console.WriteLine("BFS (НЕВЗВЕШЕННЫЙ) от вершины " + start + ":");
            foreach (var kvp in distances)
                Console.WriteLine($"До {kvp.Key} = {kvp.Value}");
        }
        ...
        public void BFS(int start)
        {
            ...
            Console.WriteLine($"Обход BFS от вершины {start}:");
            while (queue.Count > 0)
            {
                int current = queue.Dequeue();
                Console.WriteLine($"Посетили вершину {current}");
